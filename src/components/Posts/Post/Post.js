    ...
    <div className="PostCard">
      <div className="PostCard__container">
        <div className="PostCard__container__content">
          <section className="PostCard__container__content--intro" id="1">Certains débats entre dev’ font couler bcp d’encre virtuelle… Parmi les plus connus, 2 ou 4 espaces pour l’indentation, Javascript ou PHP, faut-il utiliser Redux avec React, ou encore, doit-on créer nos propres Hook avec React ? Chacun a son avis. De grandes et petites questions qui s’affrontent pour l’amour du code 😊 Voyons ça de plus près…</section>
